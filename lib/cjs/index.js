...
function getGamePath(gameId, findExecutable = false) {
    ...
    const executablePromise = new Promise((res, rej) => {
        ...
        client.on('loggedOn', async () => {
            ...
            const gameExecutableInfo = ((_d = (_c = (_b = (_a = gameData === null || gameData === void 0 ? void 0 : gameData.apps) === null || _a === void 0 ? void 0 : _a[gameId]) === null || _b === void 0 ? void 0 : _b.appinfo) === null || _c === void 0 ? void 0 : _c.config) === null || _d === void 0 ? void 0 : _d.launch) || null;
            client.logOff();

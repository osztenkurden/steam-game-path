...
function getSteamPath() {
  switch (process.platform) {
    case "linux": {
      let steamPath = import_path.default.join((0, import_os.homedir)(), ".steam", "root");
      if (import_fs.default.existsSync(steamPath)) {
        return steamPath;
      }
      steamPath = import_path.default.join((0, import_os.homedir)(), ".var", "app", "com.valvesoftware.Steam", ".local", "share", "Steam");
      if (import_fs.default.existsSync(steamPath)) {
        return steamPath;
      }
      return null;
    ...
    case "darwin": {
      const steamPath = import_path.default.join((0, import_os.homedir)(), "Library", "Application Support", "Steam");
      if (import_fs.default.existsSync(steamPath)) {
        return steamPath;
      }
      return null;
